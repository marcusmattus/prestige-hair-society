...
const clientSchema = z.object({
  ...
  NEXT_PUBLIC_CALENDLY_URL: url.optional(),
  NEXT_PUBLIC_CALENDLY_SCHEDULING_URL: url.optional(),
...
const rawClientEnv = {
  ...
  NEXT_PUBLIC_CALENDLY_SCHEDULING_URL: process.env.NEXT_PUBLIC_CALENDLY_SCHEDULING_URL,

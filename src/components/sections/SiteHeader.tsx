  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-[rgba(251,250,246,0.92)] backdrop-blur-[8px]">
      <div className="mx-auto flex max-w-[1280px] items-center gap-6 px-5 py-3.5 md:px-10 lg:gap-10">
        <a href="#top" className="flex items-center gap-3" aria-label="Prestige Hair Society — home">
          <Image
            src="/logo.jpg"
        ...
        <nav className="ml-auto hidden items-center gap-[34px] text-[14px] tracking-[0.02em] text-ink lg:flex">
          {NAV.map((item) => (
        ...
        <div className="ml-auto flex items-center gap-5 lg:ml-0">
          <a href="#account" className="hidden text-[14px] text-muted sm:inline">
            Sign in
          </a>
